...
## 💻 Run Locally in Android Studio

**Prerequisites:** [Android Studio](https://developer.android.com/studio) (Latest Stable or Ladybug)

1. Open Android Studio.
2. Select **Open** and choose the `Android-IOS-APPs` root directory.
3. Allow Android Studio to run Gradle Sync and download dependencies.
4. In the top toolbar, select your desired app from the Run Configurations dropdown (e.g., `apps.calculator.android`).
5. Hit the **Play** button to build and launch the app on your emulator or physical device!
